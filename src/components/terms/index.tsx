  ...
  return (
    <>
      ...
      <div style={{ padding: '20px 5%' }}>
        <h1 className="mt-10 mb-10">Terms and Conditions</h1>
        <p>
          Welcome to Linkwave! These terms and conditions outline the rules and regulations for the use of Linkwave's
          Website, located at www.linkwave.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use Linkwave if
        ...
        <h2 className="mt-10 mb-10">Cookies</h2>
        <p>
          We employ the use of cookies. By accessing Linkwave, you agreed to use cookies in agreement with the
          Linkwave's Privacy Policy.
        </p>
        ...
        <h2 className="mt-10 mb-10">License</h2>
        <p>
          Unless otherwise stated, Linkwave and/or its licensors own the intellectual property rights for all material
          on Linkwave. All intellectual property rights are reserved. You may access this from Linkwave for your own
          personal use subjected to restrictions set in these terms and conditions.
        </p>

        <h2 className="mt-10 mb-10">You must not:</h2>
        <ul>
          <li>Republish material from Linkwave</li>
          <li>Sell, rent or sub-license material from Linkwave</li>
          <li>Reproduce, duplicate or copy material from Linkwave</li>
          <li>Redistribute content from Linkwave</li>
        </ul>
        ...
        <p>
          ...
          areas of the website. Linkwave does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of Linkwave,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Linkwave shall not be liable for the Comments or for any liability, damages or expenses
          caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
          website.
        </p>

        <p>
          Linkwave reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>
          You hereby grant Linkwave a non-exclusive license to use, reproduce, edit and authorize others to use,
          reproduce and edit any of your Comments in any and all forms, formats or media.
        </p>

        <h2 className="mt-10 mb-10">Hyperlinking to our Content</h2>
        ...
        <p>
          ...
          Linkwave; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p>
          ...
          you must inform us by sending an e-mail to Linkwave. Please include your name, your organization name, contact
        ...
        <p>
          No use of Linkwave's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>

        <h2 className="mt-10 mb-10">iFrames</h2>
        <p>
        ...
        <h2 className="mt-10 mb-10">Content Liability</h2>
        <p>
        ...
        <h2 className="mt-10 mb-10">Your Privacy</h2>
        <p>Please read Privacy Policy</p>

        <h2 className="mt-10 mb-10">Reservation of Rights</h2>
        <p>
        ...
        <h2 className="mt-10 mb-10">Removal of links from our website</h2>
        <p>
        ...
        <h2 className="mt-10 mb-10">Disclaimer</h2>
        <p>
